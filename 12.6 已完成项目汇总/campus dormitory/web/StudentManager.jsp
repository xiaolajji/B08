                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <s:iterator id="aa" value="list">
                    <tr align="center">
                      ...
                      <td align="center"><a href="StudentUpdate.servlet?Student_ID=${Student_ID}">修改</a> <a href="StudentDel.servlet?Student_ID=${Student_ID}" onClick="return confirm('确定要删除该学生吗？')">删除</a></td>
                    </tr>
                  </s:iterator>
                </table></td>
            </tr>
