                ...
                <table width="350" height="201" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td align="center" valign="top">
                            <form name="form1" action="LoginServlet.servlet" method="post" onSubmit="return mycheck()">
                    ...
                    <%}%>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left"><select name="Type" id="Type">
                                            ...
                                            <option value="楼宇管理员">楼层管理员</option>
                                    ...
                                    <tr>
                                        <td height="30" colspan="2" align="center"><label>
                                            ...
                                            <a href="../register.jsp" class="register-btn">去注册</a>
                                        </label></td>
                                    </tr>
                                </table>
                            </form>
